...
PLATFORM_COLORS = {
    "tiktok":    {"bg": "rgba(0,0,0,0.06)",    "text": "#010101", "border": "rgba(0,0,0,0.15)"},
    "instagram": {"bg": "rgba(225,48,108,0.08)","text": "#E1306C", "border": "rgba(225,48,108,0.2)"},
    "youtube":   {"bg": "rgba(255,0,0,0.07)",   "text": "#FF0000", "border": "rgba(255,0,0,0.18)"},
}
...
STATUS_COLORS = {
    ...
    "partial": "orange", "failed": "red", "pending": "gray",
}
